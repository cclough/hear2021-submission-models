...
#### Model: my_model
```
pip install git+https://github.com/KinWaiCheuk/my_package.git@8d557f0594c22d281dbb1fa07b34d2aa0caff6aa
gdown https://drive.google.com/uc?id=1k9EMmw1Wa5xPswyp4lcw2LYmtn63eAhg
```
### Team: AMAAI Lab SUTD
License: Apache 2.0 and CC4-Attribution.
#### Model: wav2vec2\_ddsp
```
...
pip install git+https://github.com/kkoutini/passt_hear21.git@5487d2f4b7782e2879dbf6fd0b1135a5b137b106
```
### Team: CVSSP (University of Surrey)
License: MIT license. Creative Commons Attribution 4.0 International License
#### Model: PANNs
```
...
#### Model: openl3
```
pip install git+https://github.com/marl/openl3-hear.git@cfb656500517105f440cd31eac9f063680f85dc8
```
### Team: IUT-CSE
License: MIT, Creative Commons Attribution-ShareAlike 4.0 International license (CC BY-SA 4.0)
#### Model: audiomlp
```
...
```
### Team: Logitech AI
License: MIT, CC4-Attribution license.
#### Model: SERAB BYOL-S
```
pip install git+https://github.com/GasserElbanna/serab-byols.git@4188e7f21ec803f2ee3cc3b74342132ee3bb8497
...
```
### Team: NTU-GURA
License: Code: MIT license, Data: Creative Commons Attribution 4.0 International License
#### Model: avg_hubert_crepe
```
...
pip install git+https://github.com/tony10101105/HEAR-2021-NeurIPS-Challenge---NTU.git@7b7ce730d23232cec85698728fd1048800764d06
```
#### Model: fusion_cat_xwc
```
pip install git+https://github.com/tony10101105/HEAR-2021-NeurIPS-Challenge---NTU.git@7b7ce730d23232cec85698728fd1048800764d06
```
#### Model: fusion_cat_xwc_time
```
pip install git+https://github.com/tony10101105/HEAR-2021-NeurIPS-Challenge---NTU.git@7b7ce730d23232cec85698728fd1048800764d06
```
#### Model: fusion_hubert_xlarge
```
pip install git+https://github.com/tony10101105/HEAR-2021-NeurIPS-Challenge---NTU.git@7b7ce730d23232cec85698728fd1048800764d06
```
#### Model: fusion_wav2vec2
```
pip install git+https://github.com/tony10101105/HEAR-2021-NeurIPS-Challenge---NTU.git@7b7ce730d23232cec85698728fd1048800764d06
```
#### Model: hubert_xlarge
...
```
### Team: Stellenbosch LSL
License: MIT, Creative Commons Attribution 4.0 International License.
#### Model: dbert
```
...
```
### Team: UDONS
License: MIT license CC-4-BY
#### Model: embed
```
pip install git+https://github.com/faroit/udons.git@693b3624d9c5996793a3b7d3d9e942d0c0840323
